...
public class HistoryActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.weather:
                Intent weatherIntent = new Intent(HistoryActivity.this, WeatherActivity.class);
            ...
            case R.id.about:
                Intent aboutIntent = new Intent(HistoryActivity.this, AboutActivity.class);
            ...
            case R.id.transportation:
                Intent transportationIntent = new Intent(HistoryActivity.this, TransportationActivity.class);
